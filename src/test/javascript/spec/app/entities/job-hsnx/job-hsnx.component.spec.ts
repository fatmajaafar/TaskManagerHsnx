...
import { JobHsnxComponent } from 'app/entities/job-hsnx/job-hsnx.component';
import { JobHsnxService } from 'app/entities/job-hsnx/job-hsnx.service';
import { JobHsnx } from 'app/shared/model/job-hsnx.model';

describe('Component Tests', () => {
  describe('JobHsnx Management Component', () => {
    let comp: JobHsnxComponent;
    let fixture: ComponentFixture<JobHsnxComponent>;
    let service: JobHsnxService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [TaskManagerHsnxTestModule],
        declarations: [JobHsnxComponent],
        providers: [
          {
        ...
        .overrideTemplate(JobHsnxComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(JobHsnxComponent);
