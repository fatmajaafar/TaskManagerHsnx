...
import { CountryHsnxComponent } from 'app/entities/country-hsnx/country-hsnx.component';
...
describe('Component Tests', () => {
  describe('CountryHsnx Management Component', () => {
    let comp: CountryHsnxComponent;
    let fixture: ComponentFixture<CountryHsnxComponent>;
    let service: CountryHsnxService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [TaskManagerHsnxTestModule],
        declarations: [CountryHsnxComponent],
        providers: [
          {
        ...
        .overrideTemplate(CountryHsnxComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(CountryHsnxComponent);
