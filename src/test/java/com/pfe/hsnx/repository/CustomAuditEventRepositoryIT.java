...
import com.pfe.hsnx.config.audit.AuditEventConverter;
import com.pfe.hsnx.domain.PersistentAuditEvent;
...
import static com.pfe.hsnx.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
