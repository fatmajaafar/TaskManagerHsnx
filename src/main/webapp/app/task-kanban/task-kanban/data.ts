...
export let kanbanPizzaData: Object[] = [
  ...
  },
  {
    ...
    Description:
      'It made using toppings of tomato, mozzarella cheese and fresh basil, which represent the red, white and green of the Italian flag.',
    Tags: 'Onions, Pepper, Cheese',
  ...
  },
  {
    ...
    // tslint:disable-next-line: max-line-length
    Description:
      'Pizza with golden corn, exotic black olives, crunchy onions, crisp capsicum, succulent mushrooms, juicyfresh tomatoes and jalapeno with extra cheese to go all around.',
