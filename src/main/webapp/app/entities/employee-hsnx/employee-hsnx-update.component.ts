...
export class EmployeeHsnxUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    employeephone: [null, [Validators.required, Validators.minLength(8), Validators.maxLength(10)]],
    employeefax: ['', [Validators.minLength(8), Validators.maxLength(10)]],
    employeeaddress: [],
    employeeemail: [null, [Validators.required, Validators.minLength(5), Validators.maxLength(254), Validators.email]],
    employeehiredate: [],
    tblJobId: [],
    tblDepartmentId: [],
    tblBranchId: []
