...
import { DraggedItem, SortableSpec, SkyhookSortableRenderer } from '@angular-skyhook/sortable';
...
export class KanbanListComponent {
  @Input() list: KanbanList | undefined;
  @Input() preview = false;
  ...
  constructor(public specs: SortableSpecService, @Optional() public render: SkyhookSortableRenderer<KanbanList>) {}
