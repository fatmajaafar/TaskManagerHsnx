...
public class EmployeeDTO implements Serializable {
    ...
    public String getTblJobJobTitle() {
        return tblJobJobTitle;
    }

    public void setTblJobJobTitle(String JobJobTitle) {
        this.tblJobJobTitle = JobJobTitle;
    }
    ...
    public String toString() {
        return "EmployeeDTO{" +
            ...
            ", tblJobJobTitle='" + getTblJobJobTitle() + "'" +
